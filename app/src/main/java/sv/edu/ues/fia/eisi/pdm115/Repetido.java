...
public class Repetido {
    ...
    public Repetido(int IDREPETIDO, int ID_DETALLEALUMNOSEVALUADOS, String FECHASOLICITUDREPETIDO, String ESTADOREPETIDO, String FECHAREPETIDO, String HORAREPETIDO, int NOTADESPUESREPETIDO, int NOTAANTESREPETIDO, String OBSERVACIONES, String MATERIA, String LOCAL) {
