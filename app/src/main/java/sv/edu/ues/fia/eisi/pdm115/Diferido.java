...
public class Diferido {
    ...
    public Diferido(int IDDIFERIDO, int ID_DETALLEALUMNOSEVALUADOS, String FECHASOLICITUDDIFERIDO, int ESTADODIFERIDO, String FECHADIFERIDO, int NOTADIFERIDO, String OBSERVACIONESDIFERIDO, String MATERIADIFERIDO, String IDLOCAL, String MOTIVODIFERIDO, String HORADIFERIDO) {
    ...
    public int getESTADODIFERIDO() {
        return ESTADODIFERIDO;
    }

    public void setESTADODIFERIDO(int ESTADODIFERIDO) {
        this.ESTADODIFERIDO = ESTADODIFERIDO;
    }
